  ...
  const overviews = [
    {
      content: {
        ...
        link: "/",
        status: "",
        description: "We're always looking for talented individuals who share our passion for Linux security. Want to join our quest?",
        sample : "We believe in collaboration. That's why we're working closely with",
        stacks: [
    ...
    <div className="overflow-hidden mt-10" key={index}>
      <a target="_blank" rel="noreferrer noopener">
        ...
        >
          ...
          <h4 className="text-gray-400 mb-7">Together, we can create something truly amazing for the Linux ecosystem.</h4>
        </motion.div>
      </a>
    </div>
  ));
...
partnerships.Template = PageTemplate;